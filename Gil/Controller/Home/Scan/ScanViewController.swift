...
class ScanViewController: UIViewController , SkeletonTableViewDataSource, UITableViewDelegate , UITextFieldDelegate {
    ...
    func myInvitesApi(completion: @escaping () -> Void) {
        ...
        serviceManager.getGuestScanner(userId: userId) { result in
